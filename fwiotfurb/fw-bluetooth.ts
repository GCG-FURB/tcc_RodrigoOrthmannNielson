      ...
      this.bluetoothSerial.list().then(
        (dispositivos) => {
          ...
          dispositivos.forEach(d => {
            dispositivosPareados.push(new DispositivoBluetooth(d.name, null, null, d.address, d.id));
          });
    ...
    return new Promise((resolve, reject) => {
      this.bluetoothSerial.discoverUnpaired()
        .then((dispositivos) => {
          ...
          dispositivos.forEach(d => {
            dispositivosNaoPareados.push(new DispositivoBluetooth(d.name, null, null, d.address, d.id));
          });
